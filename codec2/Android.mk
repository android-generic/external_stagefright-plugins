...
LOCAL_REQUIRED_MODULES := \
	...
	manifest_media_c2_V1_2_ffmpeg.xml \
...
include $(CLEAR_VARS)
LOCAL_MODULE := manifest_media_c2_V1_2_ffmpeg.xml
LOCAL_MODULE_TAGS := optional
LOCAL_MODULE_CLASS := ETC
LOCAL_MODULE_RELATIVE_PATH := hidden_xml
LOCAL_SRC_FILES := manifest_media_c2_V1_2_ffmpeg.xml
LOCAL_POST_INSTALL_CMD := mkdir -p $(TARGET_OUT_VENDOR)/etc/vintf/manifest;
LOCAL_POST_INSTALL_CMD += cp $(LOCAL_PATH)/manifest_media_c2_V1_2_ffmpeg.fake.xml $(TARGET_OUT_VENDOR)/etc/vintf/manifest/manifest_media_c2_V1_2_ffmpeg.xml
include $(BUILD_PREBUILT)
